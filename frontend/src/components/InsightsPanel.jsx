...
function InsightsPanel({ record }) {
  ...
  return (
    <div className="rounded-xl bg-[color-mix(in_srgb,var(--ink)_6%,transparent)] p-4">
      <div className="flex items-center justify-between gap-2">
        ...
        {status !== 'success' && (
          <button
            ...
            className="rounded-lg bg-[var(--accent)] px-3 py-1.5 text-xs font-semibold text-[var(--surface)]
        ...
        <div className="mt-3 space-y-3 text-sm text-[var(--ink)]">
          ...
          {insights.warnings.length > 0 && (
            <div className="rounded-lg border border-amber-400/40 bg-amber-500/10 px-3 py-2">
              <p className="font-semibold text-amber-200">Worth knowing</p>
